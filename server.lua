...
outputChatBox(renk.."["..RenkliTakimAdi(ortakveri)..renk.."] Takımı 1 Puan Kazandı Tebrikler. [Toplam:"..kazanmax.."]",root,255,0,0,true)
rankTableRefresh(ortakveri)
...
outputChatBox(renk.."["..RenkliTakimAdi(ortakveri)..renk.."] Takımı Şampiyon Oldu Tebrikler. [Toplam:"..birincilikx.."]",root,255,0,0,true)
...
outputChatBox(renk.."Klan Puanı Kazanmak İçin Yeterli Oyuncu yok.",root,255,0,0,true)
end
end
end
end
